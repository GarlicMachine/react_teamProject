...
app.get('/memberInfo', function(request, response){
    ...
    function(err, connection){
        ...
        let query = "SELECT name 이름 ,id 아이디,phone 전화번호, jumin 주민번호, job 직업 FROM members where authority!='ROLE_ADMIN'";
...
// 박서하
// 대출 승인2
router.post('/Loans/LoanList/LoanAprovalAction2', function(request, response){
    console.log('---대출 승인2---');
    oracledb.getConnection({
        user : dbConfig.user,
        password : dbConfig.password,
