            ...
            <CRow>
                <CCol xs="12" md="12">
                    <CCard accentColor="success">
                        ...
                        <CCardBody>
                            <CForm action='/LoansProduct/LoansProductList/LoansProductInsertAction' method="POST">
                                <CFormGroup row>
                                    <CCol md="1">
                                        <CLabel htmlFor="D_NAME">대출명</CLabel>
                                    </CCol>
                                    <CCol xs="12" md="3">
                                        <CInput id="D_NAME" name="D_NAME" placeholder="대출명"/>
                                    </CCol>
                                </CFormGroup>
                                <CFormGroup row>
                                    <CCol md="1">
                                ...
                                <CFormGroup row>
                                    ...
                                    <CCol xs="12" md="3">
                                        <CInput id="D_INTEREST_RATE" name="D_INTEREST_RATE" placeholder="%"></CInput>
                                    </CCol>
                                </CFormGroup>
                                <CFormGroup row>
                                    <CCol md="1">
                                    ...
                                    <CCol xs="12" md="10">
                                        <CInput id="D_SUMMARY" name="D_SUMMARY" placeholder="대출요약"/>
                                    </CCol>
                                </CFormGroup>
                                <CFormGroup row>
                                    <CCol md="1">
                                    ...
                                    <CCol xs="12" md="3">
                                        <CInput id="D_MIN_PRICE" name="D_MIN_PRICE" placeholder="억원"/>
                                    </CCol>
                                </CFormGroup>
                                <CFormGroup row>
                                    <CCol md="1">
                                    ...
                                    <CCol xs="12" md="3">
                                        <CInput id="D_MAX_PRICE" name="D_MAX_PRICE" placeholder="억원"/>
                                    </CCol>
                                </CFormGroup>
                                <CFormGroup row>
                                    <CCol md="1">
                                    ...
                                    <CCol xs="12" md="3">
                                        <CInput id="D_MIN_DATE" name="D_MIN_DATE" placeholder="년"/>
                                    </CCol>
                                </CFormGroup>
                                <CFormGroup row>
                                    <CCol md="1">
                                    ...
                                    <CCol xs="12" md="3">
                                        <CInput id="D_MAX_DATE" name="D_MAX_DATE" placeholder="년"/>
                                    </CCol>
                                </CFormGroup>
                                <CFormGroup row>
                                    <CCol md="1">
                                    ...
                                    <CCol xs="12" md="10">
                                        <CInput id="D_EXPLANATION1" name="D_EXPLANATION1" placeholder="설명1"/>
                                    </CCol>
                                </CFormGroup>
                                <CFormGroup row>
                                    <CCol md="1">
                                    ...
                                    <CCol xs="12" md="10">
                                        <CInput id="D_EXPLANATION2" name="D_EXPLANATION2" placeholder="설명2"/>
                                    </CCol>
                                </CFormGroup>
                                <CFormGroup row>
                                    <CCol md="1">
                                    ...
                                    <CCol xs="12" md="10">
                                        <CInput id="D_EXPLANATION3" name="D_EXPLANATION3" placeholder="설명3"/>
                                    </CCol>
                                </CFormGroup>
                                <CFormGroup row>
